...
struct PlatformInfo: View {
    var body: some View {
        VStack {
            ...
            Text("Our platform creates an opportunity for the bowling community to earn and redeem rewards at their favorite centers. Made for bowlers, by bowlers, our mission is to provide a platform of inclusivity, support and feedback! ")
                .frame(maxWidth:.infinity, alignment: .leading)
                .padding([.horizontal,.bottom])
                .font(.subheadline)
                .foregroundColor(.black)
            Text("Please start by creating an account as a regular user or a bowling center below: ")
                .frame(maxWidth:.infinity, alignment: .leading)
                .padding([.horizontal,.bottom])
                .font(.subheadline)
                .foregroundColor(.black)
